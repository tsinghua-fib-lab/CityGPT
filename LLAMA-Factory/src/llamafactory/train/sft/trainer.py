...
class CustomSeq2SeqTrainer(Seq2SeqTrainer):
    ...
    def compute_loss(
        ...
        if return_outputs:
            ...
            loss = (loss[0] * ratio, *loss[1:])
        else:
            # print("not return outputs")
            loss = loss * ratio
    ...
    def _set_signature_columns_if_needed(self):
        ...
        self._signature_columns = list(set(self._signature_columns + ["ratio"]))
